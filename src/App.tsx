...
export default function App() {
  ...
  return (
    <div className="relative selection:bg-brand-accent/30 selection:text-white">
      ...
      />
      <motion.div
        className="fixed top-0 left-0 w-1.5 h-1.5 bg-brand-accent rounded-full pointer-events-none z-[100] hidden md:block shadow-[0_0_10px_#5BB8F5]"
      ...
      {/* Progress Bar */}
      <motion.div
        className="fixed top-0 left-0 right-0 h-1 bg-brand-accent origin-left z-[60] shadow-[0_0_10px_#5BB8F5]"
        style={{ scaleX }}
      />
